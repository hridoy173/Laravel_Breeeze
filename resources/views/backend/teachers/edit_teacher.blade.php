    ...
    <div class="col-md-8 col-xl-8 middle-wrapper">
            ...
            <div class="card">
              <div class="card-body">
                    ...
                    <form method="post" class="forms-sample" action="/update/teacher/{{ $teacher->id }}" >
                    @csrf
                    @method('put')
                        ...
                        <div class="mb-3">
                            ...
                            id="name" name="name" value="{{ $teacher->name }}">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            id="department" name="department" value="{{ $teacher->department }}">
                            @error('department')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            id="education_background" name="education_background" >{{ $teacher->education_background }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            id="address" name="address" >{{ $teacher->address }}</textarea>
                            @error('address')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
